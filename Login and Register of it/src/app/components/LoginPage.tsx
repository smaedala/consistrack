        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-xl">
            ...
            <p className="text-[#9CA3AF] text-lg mb-8">
              Track your performance, manage risk, and stay compliant with prop firm rules.
            </p>
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2">
                <input type="checkbox" className="w-4 h-4 rounded bg-[#1E2025] border-[#2A2D35]" />
                <span className="text-[#9CA3AF] text-sm">Remember me</span>
              </label>
              <button type="button" className="text-[#00F2FE] text-sm hover:underline">
                Forgot password?
              </button>
            </div>
